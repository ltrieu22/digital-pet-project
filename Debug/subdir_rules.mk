...
build-261764241:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-261764241-inproc

build-261764241-inproc: ../empty.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-261764241 ../empty.cfg
configPkg/compiler.opt: build-261764241
configPkg/: build-261764241
